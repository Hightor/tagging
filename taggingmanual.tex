...
% ~~~~~~~~~~~~~~~~~~~~~~~~
% This manual uses my gitinfo package which is not yet on CTAN
% If you need to format it in the meanwhile, 
% please alter this line in the preamble:
%     \usepackage[footinfo]{gitinfo}
% to this:
%     \newcommand{\gitVtag}{(None)}
% -----------------------------------------------------
